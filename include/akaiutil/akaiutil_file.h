#ifndef AKAIUTIL_FILE_H_INCLUDED_
#define AKAIUTIL_FILE_H_INCLUDED_
/*
...
int akai_sample900_noncompr2compr(struct file_s *fp, struct vol_s *volp);
int akai_sample900_compr2noncompr(struct file_s *fp, struct vol_s *volp);

#define SAMPLE2WAV_CHECK        1
#define SAMPLE2WAV_EXPORT        2
#define SAMPLE2WAV_CREATE        4
#define SAMPLE2WAV_ALL            0xff
int akai_sample2wav(struct file_s *fp, int wavfd, u_int *sizep, char **wavnamep, int what);
...
#endif  // AKAIUTIL_FILE_H_INCLUDED_
