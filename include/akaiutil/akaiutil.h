#ifndef AKAIUTIL_H_INCLUDED_
#define AKAIUTIL_H_INCLUDED_
/*
...
#define AKAI_PARTTAB_MAGICVAL    9999 /* magic base value */
  ...
  ]; /* magic fields, indicate S1000/S3000 harddisk partition table, only in first sampler partition */
...
int akai_export_ddfatchain(struct part_s *pp,
                           u_int cstart,
                           u_int bstart,
                           u_int bsize,
                           int outfd,
                           u_char *outbuf);
int akai_import_ddfatchain(struct part_s *pp,
                           u_int cstart,
                           u_int bstart,
                           u_int bsize,
                           int inpfd,
